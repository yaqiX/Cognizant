# we will be writing 3 modules for modeling
# to load data, to prepare test/train data, and to train models with K folds
...
# K refers to the number of subsets (or "folds") that the data set is divided into.
K = 10

# SPLIT is the percentage of the whole dataset used for training
# while (1 - SPLIT) is the percentage of the whole dataset used for testing
SPLIT = 0.70
...
# Train algorithm with cross validation across K folds
